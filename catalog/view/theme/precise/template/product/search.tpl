...
<div class="site-container <?php $layout = $this->config->get('itembridge_main_layout'); if ($layout=='Boxed') echo 'boxed'; if ($layout=='Wide') echo 'wide'; ?>">
    <div class="container entry-content">
        ...
        <div class="row">
            <div class="span3"><?php echo $column_left; ?></div>
            <div class="span9 content">
                ...
                <div class="buttons">
                    <input type="button" value="<?php echo $button_search; ?>" class="btn btn-primary" id="button-search" />
                </div>
                <br /><br /><br />
...
$('select[name=\'category_id\']').bind('change', function() {
	if (this.value == '0') {
		...
		$('input[name=\'sub_category\']').removeAttr('checked').trigger('refresh');;
	} else {
		$('input[name=\'sub_category\']').removeAttr('disabled').trigger('refresh');;
	}
});
