...
<div id="content" class="container">
  ...
  <div class="page-header">
    ...
    <div class="pull-right">
      <button type="submit" form="form-store" class="btn btn-success btn-sm"><i class="fa fa-check"></i> <?php echo $button_save; ?></button>
    ...
    <div class="tab-content">
      <div class="tab-pane active" id="tab-general">
        <div class="form-group required">
          ...
          <div class="col-sm-10">
            <input type="text" name="config_url" value="<?php echo $config_url; ?>" id="input-url" class="form-control input-sm">
            <?php if ($error_url) { ?>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" name="config_ssl" value="<?php echo $config_ssl; ?>" id="input-ssl" class="form-control input-sm">
          </div>
        </div>
        <div class="form-group required">
      ...
      <div class="tab-pane" id="tab-store">
        <div class="form-group required">
          ...
          <div class="col-sm-10">
			...
			<input type="text" name="config_title[<?php echo $language['language_id']; ?>]" value="<?php  if (isset($config_title[$language['language_id']])) { echo $config_title[$language['language_id']]; } ?>" id="input-title-<?php echo $language['language_id']; ?>" class="form-control input-sm">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
			...
			<?php foreach ($languages as $language) { ?>
			<textarea name="config_meta_description[<?php echo $language['language_id']; ?>]" rows="5" id="input-meta-description-<?php echo $language['language_id']; ?>" class="form-control input-sm"><?php if (isset($config_meta_description[$language['language_id']])) { echo $config_meta_description[$language['language_id']]; } ?></textarea>			
			<img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>">
			<?php } ?>
      ...
      <div class="tab-pane" id="tab-image">
        <div class="form-group">
          ...
          <div class="col-sm-10"> <img src="<?php echo $logo; ?>" alt="" id="thumb-logo"/>
            ...
            <div class="btn-group btn-group-sm">
              ...
              <button onclick="$(this).parent().parent().find('img').attr('src', '<?php echo $no_image; ?>'); $(this).parent().parent().find('input').attr('value', ''); return false;" class="btn btn-default"><span class="fa fa-trash-o"></span> <?php echo $text_clear; ?></button>
            </div>
          </div>
        </div>
        <div class="form-group">
          <label class="col-sm-2 control-label" for="input-icon"><?php echo $entry_icon; ?> </label>
          <div class="col-sm-10"><img src="<?php echo $icon; ?>" alt="" id="thumb-icon"/>
        ...
        <div class="form-group required">
          ...
          <div class="col-sm-10">
            <div class="row">
              <div class="col-lg-6">
                <input type="text" name="config_image_related_width" value="<?php echo $config_image_related_width; ?>" id="input-image-related-width" class="form-control input-sm">
              </div>
              <div class="col-lg-6">
        ...
        <div class="form-group required">
          ...
          <div class="col-sm-10">
            <div class="row">
              <div class="col-lg-6">
                <input type="text" name="config_image_compare_width" value="<?php echo $config_image_compare_width; ?>" id="input-image-compare-width" class="form-control input-sm">
              </div>
              <div class="col-lg-6">
        ...
        <div class="form-group required">
          ...
          <div class="col-sm-10">
            <div class="row">
              <div class="col-lg-6">
                <input type="text" name="config_image_wishlist_width" value="<?php echo $config_image_wishlist_width; ?>" id="input-image-wishlist-width" class="form-control input-sm">
              </div>
              <div class="col-lg-6">
        ...
        <div class="form-group required">
          ...
          <div class="col-sm-10">
            <div class="row">
              <div class="col-lg-6">
                <input type="text" name="config_image_cart_width" value="<?php echo $config_image_cart_width; ?>" id="input-image-cart-width" class="form-control input-sm">
              </div>
              <div class="col-lg-6">
