        ...
        <div class="panel-body">
          ...
          <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="text-center">
              <button type="submit" class="btn btn-success"><i class="fa fa-sign-in"></i> <?php echo $button_login; ?></button>
              <?php if ($forgotten) { ?>
               <a class="btn btn-default" href="<?php echo $forgotten; ?>"><i class="fa fa-info-circle"></i> <?php echo $text_forgotten; ?></a>
              <?php } ?>
		        </div>
