          ...
          <table class="table table-hover">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-right"><div class="btn-group"><a class="btn btn-primary btn-xs" id="button-send-<?php echo $voucher['voucher_id']; ?>" onclick="sendVoucher('<?php echo $voucher['voucher_id']; ?>');"><i class="fa fa-envelope-alt"></i> <?php echo $text_send; ?></a> <?php foreach ($voucher['action'] as $action) { ?>
