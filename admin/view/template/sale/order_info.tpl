...
<div id="content" class="container">
  ...
  <div class="page-header">
    ...
    <div class="pull-right">
        <a href="<?php echo $invoice; ?>" target="_blank" class="btn btn-info btn-sm"><i class="fa fa-print"></i> <?php echo $button_invoice; ?></a>
          ...
          <table class="table table-striped table-bordered table-hover">
            ...
            <tr>
              ...
              <td><?php if ($invoice_no) { ?>
                <?php echo $invoice_no; ?>
                <?php } else { ?>
                <button id="button-invoice" class="btn btn-success btn-xs"><i class="fa fa-cog"></i> <?php echo $text_generate; ?></button>
                <?php } ?></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><?php echo $total; ?>
                ...
                <button id="button-credit-add" class="btn btn-success btn-xs"><i class="fa fa-plus-circle"></i> <?php echo $text_credit_add; ?></button>
                <?php } else { ?>
                <button id="button-credit-remove" class="btn btn-danger btn-xs"><i class="fa fa-minus-circle"></i> <?php echo $text_credit_remove; ?></button>
                <?php } ?>
                <?php } ?></td>
            </tr>
            ...
            <tr>
              ...
              <td><?php echo $reward; ?>
                <?php if (!$reward_total) { ?>
                <button id="button-reward-add" class="btn btn-success btn-xs"><i class="fa fa-plus-circle"></i> <?php echo $text_reward_add; ?></button>
                <?php } else { ?>
                <button id="button-reward-remove" class="btn btn-danger btn-xs"><i class="fa fa-minus-circle"></i> <?php echo $text_reward_remove; ?></button>
                <?php } ?></td>
            </tr>
            <?php } ?>
            <?php if ($order_status) { ?>
            ...
            <tr>
              ...
              <td><?php echo $commission; ?>
                ...
                <button id="button-commission-add" class="btn btn-success btn-xs"><i class="fa fa-plus-circle"></i> <?php echo $text_commission_add; ?></button>
                <?php } else { ?>
                <button id="button-commission-remove" class="btn btn-danger btn-xs"><i class="fa fa-minus-circle"></i> <?php echo $text_commission_remove; ?></button>
                <?php } ?></td>
            </tr>
            <?php } ?>
            <?php if ($ip) { ?>
...
$(document).delegate('#button-credit-add', 'click', function() {
	$.ajax({
		...
		success: function(json) {
			...
			if (json['error']) {
				$('.page-header').before('<div class="alert alert-danger"><i class="fa fa-exclamation-circle"></i> ' + json['error'] + '</div>');
			}
			
			if (json['success']) {
                $('.page-header').before('<div class="alert alert-success"><i class="fa fa-check-circle"></i> ' + json['success'] + '</div>');
				
				$('.alert-success').fadeIn('slow');
				
				$('#button-credit-add').replaceWith('<button id="button-credit-remove" class="btn btn-danger btn-sm"><i class="fa fa-minus-circle"></i> <?php echo $text_credit_remove; ?></button>');
			}
		}
	});
});
...
$(document).delegate('#button-credit-remove', 'click', function() {
	$.ajax({
		...
		success: function(json) {
			...
			if (json['error']) {
				$('.page-header').before('<div class="alert alert-danger">' + json['error'] + '</div>');
			...
			if (json['success']) {
				...
				$('#button-credit-remove').replaceWith('<button id="button-credit-add" class="btn btn-success btn-sm"><i class="fa fa-plus-circle"></i> <?php echo $text_credit_add; ?></button>');
			}
		}
	});
});
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['success']) {
				...
				$('#button-reward-add').replaceWith('<button id="button-reward-remove" class="btn btn-danger btn-sm"><i class="fa fa-minus-circle"></i> <?php echo $text_reward_remove; ?></button>');
			}
		}
	});
});
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['success']) {
				...
				$('#button-reward-remove').replaceWith('<button id="button-reward-add" class="btn btn-success btn-sm"><i class="fa fa-plus-circle"></i> <?php echo $text_reward_add; ?></button>');
			}
		}
	});
});
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['success']) {
				...
				$('#button-commission-add').replaceWith('<button id="button-commission-remove" class="btn btn-danger btn-sm"><i class="fa fa-minus-circle"></i> <?php echo $text_commission_remove; ?></button>');
			}
		}
	});
});
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['success']) {
				...
				$('#button-commission-remove').replaceWith('<button id="button-commission-add" class="btn btn-success btn-sm"><i class="fa fa-minus-circle"></i> <?php echo $text_commission_add; ?></button>');
			}
		}
	});
});
