...
<div id="content" class="container">
  ...
  <div class="page-header">
    ...
    <div class="pull-right">
        <button type="submit" form="form-customer" class="btn btn-success btn-sm"><i class="fa fa-check"></i> <?php echo $button_save; ?></button>
    ...
    <div class="clearfix"></div>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-customer" class="form-horizontal">
        ...
        <div class="tab-content">
            ...
            <div class="row">
              <div class="col-sm-2">
                <ul class="nav nav-pills nav-stacked" id="address">
                  ...
                  <li><a href="#tab-address<?php echo $address_row; ?>" data-toggle="tab"><i class="fa fa-minus-circle" onclick="$('#address a[href=\'#tab-address<?php echo $address_row; ?>\']').parent().remove(); $('#tab-address<?php echo $address_row; ?>').remove();"></i> <?php echo $tab_address . ' ' . $address_row; ?></a></li>
                  <?php $address_row++; ?>
                  <?php } ?>
                ...
                <div class="tab-content">
                  <div class="tab-pane active" id="tab-customer">
                    <div class="form-group required">
                      ...
                      <div class="col-sm-10">
                        <input type="text" name="firstname" value="<?php echo $firstname; ?>" id="input-firstname" class="form-control input-sm" />
                    ...
                    <div class="form-group required">
                      ...
                      <div class="col-sm-10">
                        <input type="text" name="lastname" value="<?php echo $lastname; ?>" id="input-lastname" class="form-control input-sm" />
                    ...
                    <div class="form-group required">
                      ...
                      <div class="col-sm-10">
                        <input type="text" name="telephone" value="<?php echo $telephone; ?>" id="input-telephone" class="form-control input-sm" />
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" name="fax" value="<?php echo $fax; ?>" id="input-fax" class="form-control input-sm" />
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-2 control-label" for="input-password"><?php echo $entry_password; ?></label>
                      <div class="col-sm-10">
                        <input type="password" name="password" value="<?php echo $password; ?>" autocomplete="off" id="input-password" class="form-control input-sm" />
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="password" name="confirm" value="<?php echo $confirm; ?>" autocomplete="off" id="input-confirm" class="form-control input-sm" />
  		...
  		<label class="btn btn-default<?php if ($newsletter == 1) { ?> active<?php } ?>">
    				<i class="fa fa-check"></i> <input type="radio" name="newsletter" id="input-status" <?php if ($newsletter == 1) { ?>checked<?php } ?>> <?php echo $text_enabled; ?>
  			</label>
  			<label class="btn btn-default<?php if ($newsletter == 0) { ?> active<?php } ?>">
    				<i class="fa fa-times"></i> <input type="radio" name="newsletter" id="input-status" <?php if ($newsletter == 0) { ?>checked<?php } ?>> <?php echo $text_disabled; ?>
  			</label>
		</div>
                      </div>
                    </div>
  			...
  			<label class="btn btn-default<?php if ($status == 0) { ?> active<?php } ?>">
                  ...
                  <div class="tab-pane" id="tab-address<?php echo $address_row; ?>">
                    ...
                    <div class="form-group required">
                      ...
                      <div class="col-sm-10">
                        <input type="text" name="address[<?php echo $address_row; ?>][firstname]" value="<?php echo $address['firstname']; ?>" id="input-firstname<?php echo $address_row; ?>" class="form-control input-sm" />
                    ...
                    <div class="form-group required">
                      ...
                      <div class="col-sm-10">
                        <input type="text" name="address[<?php echo $address_row; ?>][lastname]" value="<?php echo $address['lastname']; ?>" id="input-lastname<?php echo $address_row; ?>" class="form-control input-sm" />
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" name="address[<?php echo $address_row; ?>][company]" value="<?php echo $address['company']; ?>" id="input-company<?php echo $address_row; ?>" class="form-control input-sm" />
                      </div>
                    </div>
                    <div class="form-group required">
                      <label class="col-sm-2 control-label" for="input-address-1<?php echo $address_row; ?>"><?php echo $entry_address_1; ?></label>
                      <div class="col-sm-10">
                        <input type="text" name="address[<?php echo $address_row; ?>][address_1]" value="<?php echo $address['address_1']; ?>" id="input-address-1<?php echo $address_row; ?>" class="form-control input-sm" />
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" name="address[<?php echo $address_row; ?>][address_2]" value="<?php echo $address['address_2']; ?>" id="input-address-2<?php echo $address_row; ?>" class="form-control input-sm" />
                      </div>
                    </div>
                    <div class="form-group required">
                      <label class="col-sm-2 control-label" for="input-city<?php echo $address_row; ?>"><?php echo $entry_city; ?></label>
                      <div class="col-sm-10">
                        <input type="text" name="address[<?php echo $address_row; ?>][city]" value="<?php echo $address['city']; ?>" id="input-city<?php echo $address_row; ?>" class="form-control input-sm" />
                    ...
                    <div class="form-group required">
                      ...
                      <div class="col-sm-10">
                        <input type="text" name="address[<?php echo $address_row; ?>][postcode]" value="<?php echo $address['postcode']; ?>" id="input-postcode<?php echo $address_row; ?>" class="form-control input-sm" />
                      </div>
                    </div>
                    <div class="form-group required">
                      <label class="col-sm-2 control-label" for="input-country<?php echo $address_row; ?>"><?php echo $entry_country; ?></label>
                      <div class="col-sm-10">
                        <select name="address[<?php echo $address_row; ?>][country_id]" id="input-country<?php echo $address_row; ?>" onchange="country(this, '<?php echo $address_row; ?>', '<?php echo $address['zone_id']; ?>');" class="form-control input-sm">
                    ...
                    <div class="form-group required">
                      ...
                      <div class="col-sm-10">
                        <select name="address[<?php echo $address_row; ?>][zone_id]" id="input-zone<?php echo $address_row; ?>" class="form-control input-sm">
                        </select>
          ...
          <div class="tab-pane" id="tab-history">
            ...
            <div class="text-right">
              <button id="button-history" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i> <?php echo $button_add_history; ?></button>
            </div>
          </div>
          <div class="tab-pane" id="tab-transaction">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" name="description" value="" id="input-transaction-description" class="form-control input-sm" />
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label" for="input-amount"><?php echo $entry_amount; ?></label>
              <div class="col-sm-10">
                <input type="text" name="amount" value="" id="input-amount" class="form-control input-sm" />
              </div>
            </div>
            <div class="text-right">
              <button type="button" id="button-transaction" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i> <?php echo $button_add_transaction; ?></button>
            </div>
          </div>
          <div class="tab-pane" id="tab-reward">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" name="description" value="" id="input-reward-description" class="form-control input-sm" />
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label" for="input-points"><?php echo $entry_points; ?></label>
              <div class="col-sm-10">
                <input type="text" name="points" value="" id="input-points" class="form-control input-sm" />
                </div>
            </div>
            <div class="text-right">
              <button type="button" id="button-reward" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i> <?php echo $button_add_reward; ?></button>
            </div>
          </div>
          <?php } ?>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-right"><?php if ($ip['ban_ip']) { ?>
                      <button type="button" value="<?php echo $ip['ip']; ?>" class="btn btn-info btn-xs button-ban-remove"><i class="fa fa-minus-circle"></i> <?php echo $text_remove_ban_ip; ?></button>
                      <?php } else { ?>
...
function addAddress() {	
	...
	html += '    <div class="col-sm-10"><input type="text" name="address[' + address_row + '][firstname]" value="" id="input-firstname' + address_row + '" class="form-control input-sm" /></div>';
	html += '  </div>'; 
	
	html += '  <div class="form-group required">';
	html += '    <label class="col-sm-2 control-label" for="input-lastname' + address_row + '"><?php echo $entry_lastname; ?></label>';
	html += '    <div class="col-sm-10"><input type="text" name="address[' + address_row + '][lastname]" value="" id="input-lastname' + address_row + '" class="form-control input-sm" /></div>';
	html += '  </div>'; 
	
	html += '  <div class="form-group">';
	html += '    <label class="col-sm-2 control-label" for="input-company' + address_row + '"><?php echo $entry_company; ?></label>';
	html += '    <div class="col-sm-10"><input type="text" name="address[' + address_row + '][company]" value="" id="input-company' + address_row + '" class="form-control input-sm" /></div>';
	html += '  </div>'; 
	
	html += '  <div class="form-group required">';
	html += '    <label class="col-sm-2 control-label" for="input-address-1' + address_row + '"><?php echo $entry_address_1; ?></label>';
	html += '    <div class="col-sm-10"><input type="text" name="address[' + address_row + '][address_1]" value="" id="input-address-1' + address_row + '" class="form-control input-sm" /></div>';
	html += '  </div>'; 		
	
	html += '  <div class="form-group">';
	html += '    <label class="col-sm-2 control-label" for="input-address-2' + address_row + '"><?php echo $entry_address_2; ?></label>';
	html += '    <div class="col-sm-10"><input type="text" name="address[' + address_row + '][address_2]" value="" id="input-address-2' + address_row + '" class="form-control input-sm" /></div>';
	html += '  </div>'; 
	
	html += '  <div class="form-group required">';
	html += '    <label class="col-sm-2 control-label" for="input-city' + address_row + '"><?php echo $entry_city; ?></label>';
	html += '    <div class="col-sm-10"><input type="text" name="address[' + address_row + '][city]" value="" id="input-city' + address_row + '" class="form-control input-sm" /></div>';
	html += '  </div>'; 
	
	html += '  <div class="form-group required">';
	html += '    <label class="col-sm-2 control-label" for="input-postcode' + address_row + '"><?php echo $entry_postcode; ?></label>';
	html += '    <div class="col-sm-10"><input type="text" name="address[' + address_row + '][postcode]" value="" id="input-postcode' + address_row + '" class="form-control input-sm" /></div>';
	html += '  </div>'; 

	html += '  <div class="form-group required">';
	html += '    <label class="col-sm-2 control-label" for="input-country' + address_row + '"><?php echo $entry_country; ?></label>';
	html += '    <div class="col-sm-10"><select name="address[' + address_row + '][country_id]" id="input-country' + address_row + '" onchange="country(this, \'' + address_row + '\', \'0\');" class="form-control input-sm">';
	...
	html += '    <div class="col-sm-10"><select name="address[' + address_row + '][zone_id]" id="input-zone' + address_row + '" class="form-control input-sm"><option value="false"><?php echo $this->language->get('text_none'); ?></option></select></div>';
	html += '  </div>'; 
	...
	$('#address-add').before('<li><a href="#tab-address' + address_row + '" data-toggle="tab"><i class="fa fa-minus-circle" onclick="$(\'#address a:first-child\').tab(\'show\'); $(\'a[href=\\\'#tab-address' + address_row + '\\\']\').parent().remove(); $(\'#tab-address' + address_row + '\').remove();"></i> <?php echo $tab_address; ?> ' + address_row + '</a></li>');
...
//--></script> 
<script type="text/javascript"><!--
$('#transaction').delegate('ul.pagination a', 'click', function() {
...
//--></script> 
<script type="text/javascript"><!--
$('#reward').delegate('ul.pagination a', 'click', function() {
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['success']) {
				...
				$(element).replaceWith('<button type="button" value="' + element.value + '" class="btn btn-info btn-xs button-ban-remove"><i class="fa fa-minus-circle"></i> <?php echo $text_remove_ban_ip; ?></button>');
			}
		}
	});	
});
