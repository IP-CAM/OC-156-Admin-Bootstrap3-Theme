    ...
    <div class="pull-right">
      ...
      <div class="btn-group">
        ...
        <ul class="dropdown-menu pull-right">
          <li><a onclick="$('#form-return').submit();"><?php echo $button_delete; ?></a></li>
        </ul>
      </div>
    </div>
          ...
          <table class="table table-hover">
            <thead>
              <tr>
                ...
                <td class="text-right width-10"><?php if ($sort == 'r.return_id') { ?>
                  ...
                  <?php } ?></td>
                <td class="text-right width-10"><?php if ($sort == 'r.order_id') { ?>
                  ...
                  <?php } ?></td>
                <td class="text-left width-10"><?php if ($sort == 'customer') { ?>
                  <a href="<?php echo $sort_customer; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_customer; ?></a>
                  <?php } else { ?>
                  <a href="<?php echo $sort_customer; ?>"><?php echo $column_customer; ?></a>
                  <?php } ?></td>
                <td class="text-left width-10"><?php if ($sort == 'r.product') { ?>
                  <a href="<?php echo $sort_product; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_product; ?></a>
                  <?php } else { ?>
                  <a href="<?php echo $sort_product; ?>"><?php echo $column_product; ?></a>
                  <?php } ?></td>
                <td class="text-left width-10"><?php if ($sort == 'r.model') { ?>
                  <a href="<?php echo $sort_model; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_model; ?></a>
                  <?php } else { ?>
                  <a href="<?php echo $sort_model; ?>"><?php echo $column_model; ?></a>
                  <?php } ?></td>
                <td class="text-left width-10"><?php if ($sort == 'status') { ?>
                ...
                <td class="text-left width-10"><?php if ($sort == 'r.date_added') { ?>
                  ...
                  <?php } ?></td>
                <td class="text-left width-10"><?php if ($sort == 'r.date_modified') { ?>
            ...
            <tbody>
              <tr class="filter">
                <td></td>
                <td align="right"><input type="text" name="filter_return_id" value="<?php echo $filter_return_id; ?>" class="form-control input-sm" /></td>
                <td align="right"><input type="text" name="filter_order_id" value="<?php echo $filter_order_id; ?>" class="form-control input-sm" /></td>
                <td><input type="text" name="filter_customer" value="<?php echo $filter_customer; ?>" class="form-control input-sm" /></td>
                <td><input type="text" name="filter_product" value="<?php echo $filter_product; ?>" class="form-control input-sm" /></td>
                <td><input type="text" name="filter_model" value="<?php echo $filter_model; ?>" class="form-control input-sm" /></td>
                <td><select name="filter_return_status_id" class="form-control input-sm">
                    <option value="*"></option>
                ...
                <td><input type="date" name="filter_date_added" value="<?php echo $filter_date_added; ?>" class="form-control input-sm" /></td>
                <td><input type="date" name="filter_date_modified" value="<?php echo $filter_date_modified; ?>" class="form-control input-sm" /></td>
...
?>
              ...
              <tr<?php echo ($return['status'] == $pending) ? ' class="pending"' : ' class="success"'; ?>>
                ...
                <td class="text-right"><div class="btn-group btn-group-xs"><?php foreach ($return['action'] as $action) { ?>
                  <a href="<?php echo $action['href']; ?>" class="btn<?php $text_edit = $this->language->get('text_edit'); if ( isset($text_edit) && $text_edit == $action['text'] ){ echo " btn-success";$icon = "fa fa-edit"; }else{ echo " btn-primary";$icon = "fa fa-eye"; } ?>"><i class="<?php echo $icon; ?>"></i> <?php echo $action['text']; ?></a>
                  <?php } ?></div></td>
              </tr>
              <?php } ?>
              <?php } else { ?>
