    ...
    <div class="pull-right">
      ...
      <div class="btn-group">
        ...
        <ul class="dropdown-menu pull-right">
          <li><a onclick="$('#form-customer-ban-ip').submit();"><?php echo $button_delete; ?></a></li>
        </ul>
      </div>
    </div>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-right"><?php foreach ($customer_ban_ip['action'] as $action) { ?>
                  <a href="<?php echo $action['href']; ?>" class="btn btn-defult dtn-xs"><i class="fa fa-edit"></i> <?php echo $action['text']; ?></a>
                  <?php } ?></td>
              </tr>
              <?php } ?>
              <?php } else { ?>
