...
<div id="content" class="container">
  ...
  <div class="page-header">
    ...
    <button type="submit" form="form-customer" formaction="<?php echo $approve; ?>" class="btn btn-sm btn-success"><i class="fa fa-check"></i> <?php echo $button_approve; ?></button>
      <a href="<?php echo $insert; ?>" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> <?php echo $button_insert; ?></a>
      <div class="btn-group">
        ...
        <ul class="dropdown-menu pull-right">
          <li><a onclick="$('#form-customer').submit();"><?php echo $button_delete; ?></a></li>
        </ul>
      </div>
    </div>
          ...
          <table class="table table-hover">
            <thead>
              <tr>
                ...
                <td class="text-left width-10"><?php if ($sort == 'c.email') { ?>
                  ...
                  <?php } ?></td>
                <td class="text-left width-10"><?php if ($sort == 'customer_group') { ?>
                ...
                <td class="text-left width-10"><?php if ($sort == 'c.approved') { ?>
                  ...
                  <?php } ?></td>
                <td class="text-left width-10"><?php if ($sort == 'c.ip') { ?>
                ...
                <td class="text-left width-10"><?php if ($sort == 'c.date_added') { ?>
                  ...
                  <?php } ?></td>
                <td class="text-left width-10"><?php echo $column_login; ?></td>
            ...
            <tbody>
              <tr class="filter">
                ...
                <td><input type="text" name="filter_email" value="<?php echo $filter_email; ?>" class="form-control input-sm" /></td>
                <td><select name="filter_customer_group_id" class="form-control input-sm">
                    <option value="*"></option>
                ...
                <td><select name="filter_status" class="form-control input-sm">
                    <option value="*"></option>
                ...
                <td><select name="filter_approved" class="form-control input-sm">
                    <option value="*"></option>
                ...
                <td><input type="text" name="filter_ip" value="<?php echo $filter_ip; ?>" class="form-control input-sm" /></td>
                <td><input type="date" name="filter_date_added" value="<?php echo $filter_date_added; ?>" id="date" class="form-control input-sm" /></td>
                <td></td>
                <td align="right"><button type="button" id="button-filter" class="btn btn-primary btn-sm"><i class="fa fa-search"></i> <?php echo $button_filter; ?></button></td>
              </tr>
              <?php if ($customers) { ?>
              ...
              <tr>
                ...
                <td class="text-left"><span<?php echo ($this->language->get('text_disabled') == $customer['status'])?' class="label label-warning"':' class="label label-primary"'; ?>><?php echo $customer['status']; ?></span></td>
                <td class="text-left"><?php echo $customer['approved']; ?></td>
                <td class="text-left"><?php echo $customer['ip']; ?></td>
                <td class="text-left"><?php echo $customer['date_added']; ?></td>
                <td class="text-left"><select class="form-control input-sm" onchange="((this.value !== '') ? window.open('index.php?route=sale/customer/login&token=<?php echo $token; ?>&customer_id=<?php echo $customer['customer_id']; ?>&store_id=' + this.value) : null); this.value = '';">
