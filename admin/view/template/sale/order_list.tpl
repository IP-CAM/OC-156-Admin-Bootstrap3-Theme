...
<div id="content" class="container">
  ...
  <div class="page-header">
    ...
    <div class="pull-right">
      <button type="submit" form="form-order" formaction="<?php echo $invoice; ?>" formtarget="_blank" class="btn btn-info btn-sm"><i class="fa fa-print"></i> <?php echo $button_invoice; ?></button>
          ...
          <table class="table table-hover">
            ...
            <tbody>
              <tr class="filter">
                ...
                <td><select name="filter_order_status_id" class="form-control input-sm">
                    <option value="*"></option>
                ...
                <td align="right"><input type="text" name="filter_total" value="<?php echo $filter_total; ?>" class="form-control input-sm" /></td>
...
?>
              ...
              <tr>
                ...
                <td class="text-left"><span class="label<?php echo ($order['status'] == $complete) ? ' label-success' : ' label-warning'; ?>"><?php echo $order['status']; ?></span></td>
                <td class="text-right"><?php echo $order['total']; ?></td>
                <td class="text-left"><?php echo $order['date_added']; ?></td>
                <td class="text-left"><?php echo $order['date_modified']; ?></td>
                <td class="text-right"><div class="btn-group btn-group-xs"><?php foreach ($order['action'] as $action) { ?>

		               	<a href="<?php echo $action['href']; ?>" class="btn<?php $text_edit = $this->language->get('text_edit'); if ( isset($text_edit) && $text_edit == $action['text'] ){ echo " btn-default";$icon = "fa fa-edit"; }else{ echo ($order['status'] == $complete) ? ' btn-default"' : ' btn-warning';$icon = "fa fa-eye"; } ?>"><i class="<?php echo $icon; ?>"></i> <?php echo $action['text']; ?></a>
