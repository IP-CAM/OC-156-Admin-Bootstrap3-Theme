...
<div id="content" class="container">
  ...
  <div class="page-header">
    ...
    <div class="pull-right">
      <button type="submit" form="form-return" class="btn btn-success btn-sm"><i class="fa fa-check"></i> <?php echo $button_save; ?></button>
        ...
        <div class="tab-content">
          <div class="tab-pane active" id="tab-return">
            <div class="form-group required">
              ...
              <div class="col-sm-10">
                <input type="text" name="order_id" value="<?php echo $order_id; ?>" id="input-order-id" class="form-control input-sm" />
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="date" name="date_ordered" value="<?php echo $date_ordered; ?>" id="input-date-ordered" class="form-control input-sm" />
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label" for="input-customer"><?php echo $entry_customer; ?></label>
              <div class="col-sm-10">
                <input type="text" name="customer" value="<?php echo $customer; ?>" id="input-customer" class="form-control input-sm" />
          ...
          <div class="tab-pane" id="tab-product">
            <div class="form-group required">
              ...
              <div class="col-sm-10">
                <input type="text" name="product" value="<?php echo $product; ?>" id="input-product" class="form-control input-sm" />
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label" for="input-return-reason"><?php echo $entry_reason; ?></label>
              <div class="col-sm-10">
                <select name="return_reason_id" id="input-return-reason" class="form-control input-sm">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <select name="opened" id="input-opened" class="form-control input-sm">
                  <?php if ($opened) { ?>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <textarea name="comment" rows="5" id="input-comment" class="form-control input-sm"><?php echo $comment; ?></textarea>
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label" for="input-return-action"><?php echo $entry_action; ?></label>
              <div class="col-sm-10">
                <select name="return_action_id" id="input-return-action" class="form-control input-sm">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <select name="return_status_id" id="input-return-status" class="form-control input-sm">
