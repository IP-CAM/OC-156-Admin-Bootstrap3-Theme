  ...
  <div class="page-header">
      ...
      <form action="" method="post" enctype="multipart/form-data" id="form-return">
        <div class="table-responsive">
          ...
          <tbody>
              <tr class="filter">
                  <td class="left"><input type="text" name="filter_order_recurring_id" size="4" value="<?php echo $filter_order_recurring_id ?>"  class="form-control input-sm"/></td>                  
                  <td class="center"><input type="text" name="filter_order_id" size="4" value="<?php echo $filter_order_id ?>" class="form-control input-sm" /></td>                  
                  <td class="left"><input type="text" name="filter_payment_reference" value="<?php echo $filter_payment_reference ?>" class="form-control input-sm" /></td>                  
                  <td class="left"><input type="date" name="filter_customer" value="<?php echo $filter_customer ?>" class="form-control input-sm" /></td>                  
                  <td class="left"><input type="date" name="filter_created" value="<?php echo $filter_created ?>" class="form-control input-sm" /></td>                  
                  <td class="left">
                  ...
                  <td class="text-right"><button type="button" onclick="filter()" id="button-filter" class="btn btn-primary btn-sm"><i class="fa fa-search"></i> <?php echo $text_filter; ?></button></td>                  
              </tr>
            <?php if ($profiles) { ?>
            ...
            <tr>
                ...
                <td class="right"><?php foreach ($profile['action'] as $action): ?>
                    <a href="<?php echo $action['href']; ?>" data-toggle="tooltip" title="<?php echo $action['text']; ?>" class="btn btn-xs<?php $text_edit = $this->language->get('text_edit'); if ( isset($text_edit) && $text_edit == $action['text'] ){ echo " btn-success";$icon = "fa fa-edit"; }else{ echo " btn-primary";$icon = "fa fa-eye"; } ?>"><i class="<?php echo $icon; ?>"></i> <?php echo $action['text']; ?></a>
                    <?php endforeach; ?>
                </td>
            </tr>
            <?php } ?>
