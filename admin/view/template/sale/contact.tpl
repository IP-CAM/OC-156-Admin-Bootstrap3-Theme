...
<div id="content" class="container">
  ...
  <div class="page-header">
    ...
    <div class="pull-right">
        <button id="button-send" class="btn btn-success btn-sm" onclick="send('index.php?route=marketing/contact/send&token=<?php echo $token; ?>');"><i class="fa fa-envelope"></i> <?php echo $button_send; ?></button>
    ...
    <div class="clearfix"></div>
      ...
      <form class="form-horizontal">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <select name="to" id="input-to" class="form-control input-sm">
        ...
        <div class="form-group to" id="to-customer">
          ...
          <div class="col-sm-10">
            <input type="text" name="customers" value="" id="input-customer" class="form-control input-sm" />
        ...
        <div class="form-group to" id="to-affiliate">
          ...
          <div class="col-sm-10">
            <input type="text" name="affiliates" value="" id="input-affiliate" class="form-control input-sm" />
            <br />
        ...
        <div class="form-group to" id="to-product">
          ...
          <div class="col-sm-10">
            <input type="text" name="products" value="" id="input-product" class="form-control input-sm" />
        ...
        <div class="form-group required">
          ...
          <div class="col-sm-10">
            <input type="text" name="subject" value="" id="input-subject" class="form-control input-sm" />
          </div>
        </div>
        <div class="form-group required">
          <label class="col-sm-2 control-label" for="input-message"><?php echo $entry_message; ?></label>
          <div class="col-sm-10">
            <textarea name="message" id="input-message" class="form-control input-sm"></textarea>
          </div>
        </div>
      </form>
