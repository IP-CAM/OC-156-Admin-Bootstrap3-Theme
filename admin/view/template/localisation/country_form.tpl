...
<div id="content" class="container">
  ...
  <div class="page-header">
    ...
    <div class="pull-right">
        <button type="submit" form="form-country" class="btn btn-success btn-sm"><i class="fa fa-check"></i> <?php echo $button_save; ?></button>
    ...
    <div class="clearfix"></div>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-country" class="form-horizontal">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" name="iso_code_2" value="<?php echo $iso_code_2; ?>" id="input-iso-code-2" class="form-control input-sm" />
          </div>
        </div>
        <div class="form-group">
          <label class="col-sm-2 control-label" for="input-iso-code-3"><?php echo $entry_iso_code_3; ?></label>
          <div class="col-sm-10">
            <input type="text" name="iso_code_3" value="<?php echo $iso_code_3; ?>" id="input-iso-code-3" class="form-control input-sm" />
          </div>
        </div>
        <div class="form-group">
          <label class="col-sm-2 control-label" for="input-address-format"><?php echo $entry_address_format; ?> </label>
          <div class="col-sm-10">
            <textarea name="address_format" rows="5" id="input-address-format" class="form-control input-sm"><?php echo $address_format; ?></textarea>
	</div>
        </div>
        <div class="form-group">
		...
		<div class="btn-group btn-group-sm" data-toggle="buttons">
  			...
  			<label class="btn btn-default<?php if ($postcode_required == 1) { ?> active<?php } ?>">
  			...
  			<label class="btn btn-default<?php if ($postcode_required == 0) { ?> active<?php } ?>">
