    ...
    <div class="pull-right">
        ...
        <div class="btn-group">
          ...
          <ul class="dropdown-menu pull-right">
            <li><a onclick="$('#form-return-status').submit();"><?php echo $button_delete; ?></a></li>
          </ul>
        </div>
    </div>
        ...
        <div class="table-responsive">
          <table class="table table-hover">
            ...
            <tbody>
              ...
              <tr>
                <td class="text-center"><?php if ($return_status['selected']) { ?>
                  ...
                  <?php } ?></td>
                <td class="text-left"><?php $return_status['name'] = str_replace('<b>(', '<span class="label label-primary">', $return_status['name']);$return_status['name'] = str_replace(')</b>', '</span>', $return_status['name']); echo $return_status['name']; ?></td>
                <td class="text-right"><?php foreach ($return_status['action'] as $action) { ?>
