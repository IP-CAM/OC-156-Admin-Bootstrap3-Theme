    ...
    <div class="pull-right">
        ...
        <div class="btn-group">
          ...
          <ul class="dropdown-menu pull-right">
            <li><a onclick="$('#form-order-status').submit();"><?php echo $button_delete; ?></a></li>
          </ul>
        </div>
    </div>
        ...
        <div class="table-responsive">
          <table class="table table-hover">
            ...
            <tbody>
              ...
              <tr>
                <td class="text-center"><?php if ($order_status['selected']) { ?>
                  ...
                  <?php } ?></td>
                <td class="text-left"><?php $order_status['name'] = str_replace('<b>(', '<span class="label label-primary">', $order_status['name']);$order_status['name'] = str_replace(')</b>', '</span>', $order_status['name']); echo $order_status['name']; ?></td>
