    ...
    <div class="pull-right">
        ...
        <div class="btn-group">
          ...
          <ul class="dropdown-menu pull-right">
            <li><a onclick="$('#form-language').submit();"><?php echo $button_delete; ?></a></li>
          </ul>
        </div>
    </div>
        ...
        <div class="table-responsive">
          <table class="table table-hover">
            ...
            <tbody>
              ...
              <tr>
                <td class="text-center"><?php if ($language['selected']) { ?>
                  ...
                  <?php } ?></td>
                <td class="text-left"><?php $language['name'] = str_replace('<b>(', '<span class="label label-primary">', $language['name']);$language['name'] = str_replace(')</b>', '</span>', $language['name']); echo $language['name']; ?></td>
