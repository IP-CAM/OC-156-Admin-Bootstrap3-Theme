    ...
    <div class="pull-right">
        ...
        <div class="btn-group">
          ...
          <ul class="dropdown-menu pull-right">
            <li><a onclick="$('#form-stock-status').submit();"><?php echo $button_delete; ?></a></li>
          </ul>
        </div>
    </div>
            ...
            <tbody>
              ...
              <tr>
                <td class="text-center"><?php if ($stock_status['selected']) { ?>
                  ...
                  <?php } ?></td>
                <td class="text-left"><?php $stock_status['name'] = str_replace('<b>(', '<span class="label label-primary">', $stock_status['name']);$stock_status['name'] = str_replace(')</b>', '</span>', $stock_status['name']); echo $stock_status['name']; ?></td>
