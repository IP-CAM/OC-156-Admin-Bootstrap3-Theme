...
<div id="content" class="container">
  ...
  <div class="page-header">
    ...
    <div class="pull-right">
        <button type="submit" form="form-return-status" class="btn btn-success btn-sm"><i class="fa fa-check"></i> <?php echo $button_save; ?></button>
        ...
        <div class="form-group required">
          ...
          <div class="col-sm-10">
            ...
            <div class="input-group"> <span class="input-group-addon input-sm"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
              <input type="text" name="return_status[<?php echo $language['language_id']; ?>][name]" value="<?php echo isset($return_status[$language['language_id']]) ? $return_status[$language['language_id']]['name'] : ''; ?>" class="form-control input-sm" />
            </div>
