    ...
    <div class="pull-right">
        ...
        <div class="btn-group">
          ...
          <ul class="dropdown-menu pull-right">
            <li><a onclick="$('#form-currency').submit();"><?php echo $button_delete; ?></a></li>
          </ul>
        </div>
    </div>
            ...
            <tbody>
              ...
              <tr>
                <td class="text-center"><?php if ($currency['selected']) { ?>
                  ...
                  <?php } ?></td>
                <td class="text-left"><?php $currency['title'] = str_replace('<b>(', '<span class="label label-primary">', $currency['title']);$currency['title'] = str_replace(')</b>', '</span>', $currency['title']); echo $currency['title']; ?></td>
