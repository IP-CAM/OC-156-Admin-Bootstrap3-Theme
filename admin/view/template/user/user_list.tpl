    ...
    <div class="pull-right">
        ...
        <div class="btn-group">
          ...
          <ul class="dropdown-menu pull-right">
            <li><a onclick="$('#form-user').submit();"><?php echo $button_delete; ?></a></li>
          </ul>
        </div>
    </div>
          ...
          <table class="table table-hover">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-left"><span<?php echo ($this->language->get('text_disabled') == $user['status'])?' class="label label-danger"':' class="label label-default"'; ?>><?php echo $user['status']; ?></span></td>
