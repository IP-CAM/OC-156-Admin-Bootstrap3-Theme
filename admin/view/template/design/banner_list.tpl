    ...
    <div class="pull-right">
        ...
        <div class="btn-group">
          ...
          <ul class="dropdown-menu pull-right">
            <li><a onclick="$('#form-banner').submit();"><?php echo $button_delete; ?></a></li>
          </ul>
        </div>
    </div>
        ...
        <div class="table-responsive">
          <table class="table table-hover">
            ...
            <tbody>
              ...
              <tr>
                <td class="text-center"><?php if ($banner['selected']) { ?>
                ...
                <td class="text-left"><span<?php echo ($this->language->get('text_disabled') == $banner['status'])?' class="label label-danger"':' class="label label-primary"'; ?>><?php echo $banner['status']; ?></span></td>
                <td class="text-right"><?php foreach ($banner['action'] as $action) { ?>
