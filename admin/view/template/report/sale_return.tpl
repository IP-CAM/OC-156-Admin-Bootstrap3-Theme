      ...
      <form class="form-horizontal">
        <div class="well">
          <div class="row">
            ...
            <div class="col-sm-5">
              <div class="form-group">
                <label class="col-sm-3 control-label" for="input-group"><?php echo $entry_group; ?></label>
                <div class="col-sm-9">
                  <select name="filter_group" id="input-group" class="form-control input-sm">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <select name="filter_return_status_id" id="input-status" class="form-control input-sm">
