              ...
              <table class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="text-left"><select name="information_layout[0][layout_id]" class="form-control input-sm">
                        <option value=""></option>
                  ...
                  <tr>
                    ...
                    <td class="text-left"><select name="information_layout[<?php echo $store['store_id']; ?>][layout_id]" class="form-control input-sm">
                        <option value=""></option>
                        <?php foreach ($layouts as $layout) { ?>
