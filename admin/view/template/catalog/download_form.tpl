...
<div id="content" class="container">
  ...
  <div class="page-header">
    ...
    <div class="pull-right">
      <button type="submit" form="form-download" class="btn btn-success btn-sm"><i class="fa fa-check"></i> <?php echo $button_save; ?></button>
    ...
    <div class="clearfix"></div>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-download" class="form-horizontal">
        <div class="form-group required">
          ...
          <div class="col-sm-10">
            ...
            <div class="input-group"> <span class="input-group-addon input-sm"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
              <input type="text" name="download_description[<?php echo $language['language_id']; ?>][name]" value="<?php echo isset($download_description[$language['language_id']]) ? $download_description[$language['language_id']]['name'] : ''; ?>" class="form-control input-sm" />
            </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <div class="input-group">
              ...
              <button type="button" onclick="$('input[name=\'file\']').click();" id="button-upload" class="btn btn-primary btn-sm"><i class="fa fa-upload"></i> <?php echo $button_upload; ?></button>
              </span></div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" name="mask" value="<?php echo $mask; ?>" id="input-mask" class="form-control input-sm" />
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" name="remaining" value="<?php echo $remaining; ?>" id="input-remaining" class="form-control input-sm" />
          </div>
        </div>
        <?php if ($download_id) { ?>
        <div class="form-group">
