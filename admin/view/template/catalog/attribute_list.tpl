    ...
    <div class="pull-right"><a href="<?php echo $insert; ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> <?php echo $button_insert; ?></a>
      <div class="btn-group btn-group-sm">
        ...
        <ul class="dropdown-menu pull-right">
          <li><a onclick="$('#form-attribute').submit();"><?php echo $button_delete; ?></a></li>
        </ul>
      </div>
    </div>
            ...
            <thead>
              <tr>
                ...
                <td class="text-left"><?php if ($sort == 'ad.name') { ?>
                  ...
                  <?php } ?></td>
                <td class="text-left width-10"><?php if ($sort == 'attribute_group') { ?>
                  ...
                  <?php } ?></td>
                <td class="text-right width-10"><?php if ($sort == 'a.sort_order') { ?>
