...
<div id="content" class="container">
  ...
  <div class="page-header">
    ...
    <div class="pull-right">
      <a href="<?php echo $insert; ?>" class="btn btn-primary btn-sm">
        <i class="fa fa-plus"></i> <?php echo $button_insert; ?>
      </a>
      <a href="<?php echo $repair; ?>" class="btn btn-default btn-sm">
        <i class="fa fa-wrench"></i> <?php echo $button_repair; ?>
      </a>
      <div class="btn-group btn-group-sm">
        <button type="button" class="btn btn-danger dropdown-toggle" data-toggle="dropdown">
          <i class="fa fa-trash-o"></i> <?php echo $button_delete; ?> <i class="fa fa-caret-down"></i>
        </button>
