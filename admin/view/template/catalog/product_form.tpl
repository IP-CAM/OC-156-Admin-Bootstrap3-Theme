            ...
            <div class="tab-content">
              ...
              <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="product_description[<?php echo $language['language_id']; ?>][meta_keyword]" rows="5" id="input-meta-keyword<?php echo $language['language_id']; ?>" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['meta_keyword'] : ''; ?>" data-role="tagsinput" class="width-50 form-control">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" name="product_description[<?php echo $language['language_id']; ?>][tag]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['tag'] : ''; ?>" id="input-tag<?php echo $language['language_id']; ?>" data-role="tagsinput" class="width-50 form-control" />
                    </div>
                </div>
              </div>
              <?php } ?>
              ...
              <table id="attribute" class="table table-hover">
                ...
                <tbody>
                  ...
                  <tr id="attribute-row<?php echo $attribute_row; ?>">
                    <td class="text-left"><input type="text" name="product_attribute[<?php echo $attribute_row; ?>][name]" value="<?php echo $product_attribute['name']; ?>" class="form-control input-sm" />
                    ...
                    <td class="text-left"><?php foreach ($languages as $language) { ?>
                      ...
                      <?php } ?></td>
                    <td class="text-left"><button type="button" onclick="$('#attribute-row<?php echo $attribute_row; ?>').remove();" class="btn btn-danger btn-sm"><i class="fa fa-minus-circle"></i> <?php echo $button_remove; ?></button></td>
                  </tr>
                  <?php $attribute_row++; ?>
                  <?php } ?>
                </tbody>
                <tfoot>
                  <tr>
                    <td colspan="2"></td>
                    <td class="text-left"><button type="button" onclick="addAttribute();" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i> <?php echo $button_add_attribute; ?></button></td>
                  </tr>
                </tfoot>
              </table>
            </div>
                      ...
                      <table id="option-value<?php echo $option_row; ?>" class="table table-hover">
                        ...
                        <tbody>
                          ...
                          <tr id="option-value-row<?php echo $option_value_row; ?>">
                            <td class="text-left"><select name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][option_value_id]" class="form-control input-sm">
                            ...
                            <td class="text-left"><select name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][subtract]" class="form-control input-sm">
                            ...
                            <td class="text-left"><button type="button" onclick="$('#option-value-row<?php echo $option_value_row; ?>').remove();" class="btn btn-danger btn-sm"><i class="fa fa-minus-circle"></i> <?php echo $button_remove; ?></button></td>
                          </tr>
                        ...
                        <tfoot>
                          <tr>
                            <td colspan="6"></td>
                            <td class="text-left"><button type="button" onclick="addOptionValue('<?php echo $option_row; ?>');" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i> <?php echo $button_add_option_value; ?></button></td>
                          </tr>
                        </tfoot>
                      </table>
                    </div>
              ...
              <table id="discount" class="table table-hover">
                ...
                <tbody>
                  ...
                  <tr id="discount-row<?php echo $discount_row; ?>">
                    <td class="text-left"><select name="product_discount[<?php echo $discount_row; ?>][customer_group_id]" class="form-control input-sm">
                    ...
                    <td class="text-left"><input type="date" name="product_discount[<?php echo $discount_row; ?>][date_start]" value="<?php echo $product_discount['date_start']; ?>" class="form-control input-sm" /></td>
                    <td class="text-left"><input type="date" name="product_discount[<?php echo $discount_row; ?>][date_end]" value="<?php echo $product_discount['date_end']; ?>"  class="form-control input-sm" /></td>
                    <td class="text-left"><button type="button" onclick="$('#discount-row<?php echo $discount_row; ?>').remove();" class="btn btn-danger btn-sm"><i class="fa fa-minus-circle"></i> <?php echo $button_remove; ?></button></td>
                  </tr>
                  <?php $discount_row++; ?>
                  <?php } ?>
                </tbody>
                <tfoot>
                  <tr>
                    <td colspan="6"></td>
                    <td class="text-left"><button type="button" onclick="addDiscount();" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i> <?php echo $button_add_discount; ?></button></td>
                  </tr>
                </tfoot>
              </table>
            </div>
              ...
              <table id="special" class="table table-hover">
                ...
                <tbody>
                  ...
                  <tr id="special-row<?php echo $special_row; ?>">
                    <td class="text-left"><select name="product_special[<?php echo $special_row; ?>][customer_group_id]" class="form-control input-sm">
                        <?php foreach ($customer_groups as $customer_group) { ?>
                    ...
                    <td class="text-left"><input type="date" name="product_special[<?php echo $special_row; ?>][date_start]" value="<?php echo $product_special['date_start']; ?>" class="form-control input-sm" /></td>
                    <td class="text-left"><input type="date" name="product_special[<?php echo $special_row; ?>][date_end]" value="<?php echo $product_special['date_end']; ?>" class="form-control input-sm" /></td>
                    <td class="text-left"><button type="button" onclick="$('#special-row<?php echo $special_row; ?>').remove();" class="btn btn-danger btn-sm"><i class="fa fa-minus-circle"></i> <?php echo $button_remove; ?></button></td>
                  </tr>
                  <?php $special_row++; ?>
                  <?php } ?>
                </tbody>
                <tfoot>
                  <tr>
                    <td colspan="5"></td>
                    <td class="text-left"><button type="button" onclick="addSpecial();" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i> <?php echo $button_add_special; ?></button></td>
                  </tr>
                </tfoot>
              </table>
            </div>
              ...
              <table id="images" class="table table-hover">
                ...
                <tbody>
                  ...
                  <tr id="image-row<?php echo $image_row; ?>">
                    <td class="text-left"><img src="<?php echo $product_image['thumb']; ?>" alt="" class="img-thumbnail" id="thumb<?php echo $image_row; ?>" />
                    ...
                    <td class="text-left"><div class="btn-group btn-group-sm">
                    ...
                    <td class="text-left"><button type="button" onclick="$('#image-row<?php echo $image_row; ?>').remove();" class="btn btn-danger btn-sm"><i class="fa fa-minus-circle"></i> <?php echo $button_remove; ?></button></td>
                  </tr>
                  <?php $image_row++; ?>
                  <?php } ?>
                </tbody>
                <tfoot>
                  <tr>
                    <td colspan="3"></td>
                    <td class="text-left"><button type="button" onclick="addImage();" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i> <?php echo $button_add_image; ?></button></td>
                  </tr>
                </tfoot>
              </table>
            </div>
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="text-left"><select name="product_layout[0][layout_id]" class="form-control input-sm">
                        <option value=""></option>
                  ...
                  <tr>
                    ...
                    <td class="text-left"><select name="product_layout[<?php echo $store['store_id']; ?>][layout_id]" class="form-control input-sm">
                        <option value=""></option>
                        <?php foreach ($layouts as $layout) { ?>
...
function addAttribute() {
	...
	html += '  <td class="text-left"><input type="text" name="product_attribute[' + attribute_row + '][name]" value="" class="form-control input-sm" /><input type="hidden" name="product_attribute[' + attribute_row + '][attribute_id]" value="" /></td>';
    ...
    <?php } ?>
	html += '  </td>';
	html += '  <td class="text-left"><button type="button" onclick="$(\'#attribute-row' + attribute_row + '\').remove();" class="btn btn-danger btn-sm"><i class="fa fa-minus-circle"></i> <?php echo $button_remove; ?></button></td>';
    html += '</tr>';
...
$('input[name=\'option\']').autocomplete({
	...
	'select': function(item) {
		...
		if (item['type'] == 'select' || item['type'] == 'radio' || item['type'] == 'checkbox' || item['type'] == 'image') {
			...
			html += '        <td class="text-left"><button type="button" onclick="addOptionValue(' + option_row + ');" class="btn btn-primary btn-sm"><i class="fa fa-plus-circle"></i> <?php echo $button_add_option_value; ?></button></td>';
			html += '      </tr>';
			html += '    </tfoot>';
			html += '  </table>';
			html += '</div>';
...
function addOptionValue(option_row) {	
	...
	html += '  <td class="text-left"><button type="button" onclick="$(\'#option-value-row' + option_value_row + '\').remove();" class="btn btn-danger btn-sm"><i class="fa fa-minus-circle"></i> <?php echo $button_remove; ?></button></td>';
	html += '</tr>';
...
function addDiscount() {
    ...
    html += '  <td class="text-left"><input type="date" name="product_discount[' + discount_row + '][date_start]" value="" class="form-control input-sm" /></td>';
	html += '  <td class="text-left"><input type="date" name="product_discount[' + discount_row + '][date_end]" value="" class="form-control input-sm" /></td>';
	html += '  <td class="text-left"><button type="button" onclick="$(\'#discount-row' + discount_row + '\').remove();" class="btn btn-danger btn-sm"><i class="fa fa-minus-circle"></i> <?php echo $button_remove; ?></button></td>';
	html += '</tr>';	
...
function addSpecial() {
    ...
    html += '  <td class="text-left"><input type="date" name="product_special[' + special_row + '][date_start]" value="" class="form-control input-sm" /></td>';
	html += '  <td class="text-left"><input type="date" name="product_special[' + special_row + '][date_end]" value="" class="form-control input-sm" /></td>';
	html += '  <td class="text-left"><button type="button" onclick="$(\'#special-row' + special_row + '\').remove();" class="btn btn-danger btn-sm"><i class="fa fa-minus-circle"></i> <?php echo $button_remove; ?></button></td>';
	html += '</tr>';
...
function addImage() {
	...
	html += '  <td class="text-left"><img src="<?php echo $no_image; ?>" alt="" class="img-thumbnail" id="thumb' + image_row + '"/><input type="hidden" name="product_image[' + image_row + '][image]" value="" id="image' + image_row + '"/></td>';
	html += '  <td class="text-left"><div class="btn-group btn-group-sm"><button type="button" data-toggle="modal" data-target="#dialog" class="btn btn-primary" onclick="image_upload(\'image' + image_row + '\', \'thumb' + image_row + '\');"><span class="fa fa-pencil"></span> <?php echo $text_browse; ?></button><button class="btn btn-default btn-sm" onclick="$(\'#thumb' + image_row + '\').attr(\'src\', \'<?php echo $no_image; ?>\'); $(\'#image' + image_row + '\').attr(\'value\', \'\');return false"><span class="fa fa-trash-o"></span> <?php echo $text_clear; ?></button></div></td>';
	html += '  <td class="text-right"><input type="text" name="product_image[' + image_row + '][sort_order]" value="" class="form-control input-sm" /></td>';
	html += '  <td class="text-left"><button type="button" onclick="$(\'#image-row' + image_row  + '\').remove();" class="btn btn-danger btn-sm"><i class="fa fa-minus-circle"></i> <?php echo $button_remove; ?></button></td>';
	html += '</tr>';
