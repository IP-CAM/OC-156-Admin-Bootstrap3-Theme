          ...
          <table class="table table-hover">
            ...
            <tbody>
              <tr>
                ...
                <td class="text-left"><select name="category_layout[0][layout_id]" class="form-control input-sm">
                    <option value=""></option>
              ...
              <tr>
                ...
                <td class="text-left"><select name="category_layout[<?php echo $store['store_id']; ?>][layout_id]" class="form-control input-sm">
                    <option value=""></option>
                    <?php foreach ($layouts as $layout) { ?>
