        ...
        <table class="table table-hover">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-left hidden-xs"><span<?php echo ($this->language->get('text_disabled') == $extension['status'])?' class="label label-danger"':' class="label label-success"'; ?>><?php echo $extension['status'] ?></span></td>
