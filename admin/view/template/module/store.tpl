  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <div class="pull-right">
        <button type="submit" form="form-store" class="btn btn-primary btn-xs"><i class="fa fa-check"></i> <?php echo $button_save; ?></button>
        ...
        <table id="module" class="table table-striped table-bordered table-hover">
          ...
          <tbody>
            ...
            <tr id="module-row<?php echo $module_row; ?>">
              ...
              <td class="text-right"><input type="text" name="store_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" class="form-control" /></td>
...
function addModule() {	
    ...
    html += '  </select></td>';
	html += '  <td class="text-right"><input type="text" name="store_module[' + module_row + '][sort_order]" value="" class="form-control" /></td>';
