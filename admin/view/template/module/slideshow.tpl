  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <div class="pull-right">
        <button type="submit" form="form-slideshow" class="btn btn-primary btn-xs"><i class="fa fa-check"></i> <?php echo $button_save; ?></button>
        ...
        <table id="module" class="table table-striped table-bordered table-hover">
          ...
          <tbody>
            ...
            <tr id="module-row<?php echo $module_row; ?>">
              ...
              <td class="text-left"><input type="text" name="slideshow_module[<?php echo $module_row; ?>][width]" value="<?php echo $module['width']; ?>" class="form-control" />
                <input type="text" name="slideshow_module[<?php echo $module_row; ?>][height]" value="<?php echo $module['height']; ?>" class="form-control" />
              ...
              <td class="text-right"><input type="text" name="slideshow_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" class="form-control" /></td>
...
function addModule() {	
	...
	<?php } ?>
	html += '  </select></td>';
	html += '  <td class="text-left"><input type="text" name="slideshow_module[' + module_row + '][width]" value="" class="form-control" /> <input type="text" name="slideshow_module[' + module_row + '][height]" value="" class="form-control" /></td>';
    ...
    html += '  </select></td>';
	html += '  <td class="text-right"><input type="text" name="slideshow_module[' + module_row + '][sort_order]" value="" class="form-control" /></td>';
