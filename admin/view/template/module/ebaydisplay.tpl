        ...
        <table id="module" class="table table-striped table-bordered table-hover">
          ...
          <tbody>
            ...
            <tr id="module-row<?php echo $module_row; ?>">
              ...
              <td class="text-right"><input type="text" name="ebaydisplay_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" class="form-control" /></td>
...
function addModule() {	
    ...
    html += '  </select></td>';
	html += '  <td class="text-right"><input type="text" name="ebaydisplay_module[' + module_row + '][sort_order]" value="" class="form-control" /></td>';
