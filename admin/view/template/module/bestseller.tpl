  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <div class="pull-right">
        <button type="submit" form="form-bestseller" class="btn btn-primary btn-xs"><i class="fa fa-check"></i> <?php echo $button_save; ?></button>
        ...
        <table id="module" class="table table-striped table-bordered table-hover">
          ...
          <tbody>
            ...
            <tr id="module-row<?php echo $module_row; ?>">
              <td class="text-left"><input type="text" name="bestseller_module[<?php echo $module_row; ?>][limit]" value="<?php echo $module['limit']; ?>" class="form-control" /></td>
              <td class="text-left"><input type="text" name="bestseller_module[<?php echo $module_row; ?>][image_width]" value="<?php echo $module['image_width']; ?>" class="form-control" />
                <input type="text" name="bestseller_module[<?php echo $module_row; ?>][image_height]" value="<?php echo $module['image_height']; ?>" class="form-control" />
              ...
              <td class="text-right"><input type="text" name="bestseller_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" class="form-control" /></td>
...
function addModule() {	
	...
	html += '  <td class="text-left"><input type="text" name="bestseller_module[' + module_row + '][limit]" value="5" class="form-control" /></td>';
	html += '  <td class="text-left"><input type="text" name="bestseller_module[' + module_row + '][image_width]" value="80" class="form-control" /> <input type="text" name="bestseller_module[' + module_row + '][image_height]" value="80" class="form-control" /></td>'; 
    ...
    html += '  </select></td>';
	html += '  <td class="text-right"><input type="text" name="bestseller_module[' + module_row + '][sort_order]" value="" class="form-control" /></td>';
